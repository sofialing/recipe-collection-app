    ...
    return (
        <div className="p-4 md:w-1/2 lg:w-1/3 xl:w-1/4">
            <div className="h-full flex flex-col border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                <img className="md:h-52 lg:h-60 w-full object-cover object-center" src={recipe.image} alt="recipe" />
                <div className="p-6 flex-grow flex flex-col">
                    <h3 className="tracking-widest text-xs font-medium uppercase text-gray-400 mb-1">{recipe.category}</h3>
