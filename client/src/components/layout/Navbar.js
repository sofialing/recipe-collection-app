...
const Navbar = () => {
    ...
    return (
        <header className="text-gray-500 bg-white shadow-sm">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto flex flex-wrap items-center justify-center tracking-wider">
                ...
                {user
                    ? (<button onClick={() => logout()} className="inline-flex btn btn-outline btn-sm">Log out
                    </button>)
                    : (<Link to="/login" className="inline-flex btn btn-outline btn-sm">Log in
                    </Link>)
                }
