...
const MobileMenu = () => {
    return (
        <div className="fixed shadow-lg -inset-x-0 bottom-0 bg-gray-100 text-gray-700 h-20 px-5 border-t border-gray-300 md:hidden">
            <ul className="flex justify-between items-center h-full text-center text-xs uppercase tracking-wider font-medium">
                <li className="flex-1">
                    <NavLink to="/add-recipe" className="flex flex-col items-center">
                ...
                <li className="flex-1">
                    <NavLink to="/recipes" className="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-2 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li className="flex-1">
                    <NavLink to="/meal-planner" className="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mb-2 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
