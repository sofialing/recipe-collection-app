            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto my-6 mx-auto max-w-6xl">
                    <div className="border-0 rounded-lg shadow-lg p-8 relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        <button aria-label="Close modal" title="Close modal" className="absolute rounded-full p-2 bg-gray-700 text-white right-4 top-4" onClick={() => setShowModal(prevState => !prevState)}>
